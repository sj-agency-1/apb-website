...
export const aboutPageContent: LocalizedContent<AboutPageContent> = {
  ru: {
    ...
    welcomeDescription:
      'Личный Бренд — это не просто яркое название, красивая внешность или набор постов в социальных сетях. С помощью сервиса «APB» Вы можете преобразовать свои таланты, навыки и своё имя в полноценный цифровой актив с высоким потенциалом монетизации.\nПри одном единственном условии — если Вы сами решите относиться к нему так же серьезно, как к любому проекту, нацеленному на устойчивый финансовый результат. «Вишенка на торте» заключается в том, что онлайн-бизнес под названием «Личный Бренд» принадлежит только ВАМ.',
    ...
    secretParagraph2:
      '«Архитектор Личных Брендов» работает иначе. С помощью инструментов сервиса Вы не просто «пиаритесь», а с нуля проектируете Ваш онлайн бизнес.\nВы разрабатываете полноценную, эффективную и нацеленную на доход бизнес-модель, заточенную под Вас как под конкретную личность: начиная от глубинного аудита и разработки позиционирования и заканчивая проектированием авторских цифровых продуктов с рассчитанным бизнес-планом, включающим финансовую модель и дорожную карту.',

    serviceTitle: 'Что именно Вы создаете с помощью сервиса?',
    serviceIntro:
      'Представьте, что Личный бренд – это ваш дом. Обычные специалисты могут красиво покрасить стены, сделать дизайн интерьера, повесить дорогие шторы (сделать рекламу и PR).\nС помощью сервиса «Архитектор Личных Брендов» Вы проектируете и строите «здание» с нуля: закладываете фундамент, прокладываете коммуникации, возводите несущие конструкции и только потом приступаете к отделке и благоустройству.',
    serviceCards: [
      {
      ...
      },
      {
        ...
        description:
          'С помощью инструментов сервиса Вы проводите исследование рынка и ниши, чтобы определить оптимальную стратегию ценообразования. Вы формируете подробный бизнес-план и финансовую модель — документы, создание которых у профессиональных аналитиков стоит тысячи долларов и занимает месяцы.',
        icon: 'financial',
      },
      {
    ...
    reliabilityParagraph2:
      'AI-сервис «Архитектор Личных Брендов» - это авторский проект профессионального бизнес-консультанта, известного под псевдонимом Business Pathfinder, с 28-летним опытом в кризис-менеджементе, бизнес-аналитике, сопровождении M&A-сделок и экспансии на международные рынки.',
    reliabilityParagraph3:
      'Этот опыт и позволил разработать систему, которая помогает Вам создавать успешные модели, учитывая даже психологический аспект: при создании сильного бренда важно быть откровенным, но люди часто стесняются раскрываться перед живым консультантом.\n«Архитектор Личных Брендов» решает эту проблему, благодаря использованию ИИ: Пользователь знает, что общается с безличным интеллектом. Это снимает психологические барьеры. Человек перестает стесняться, отбрасывает страх осуждения, оценки или непонимания и готов отвечать максимально честно, прямо и открыто.',
    ...
    brandParagraph2:
      'С помощью сервиса Вы проектируете Личный Бренд, основанный на Вашем внутреннем мире и талантах, а не на картинке. Если Вы не хотите показывать лицо — Вы можете этого не делать. С помощью методологии APB Вы создаете бизнес-модель, которая может работать, даже когда Вы остаетесь в тени.',
    brandListItems: [],
    brandParagraph3: '',

    scoutTitle: 'ЖИВОЕ ДОКАЗАТЕЛЬСТВО СТРАТЕГИИ',
    scoutParagraph1:
      'Вы можете убедиться в этом сами: Основатель сервиса, Бизнес-Следопыт, сам ведет бизнес под псевдонимом и не демонстрирует свое лицо. Его успех — это живой пример того, что с помощью правильных инструментов можно создать масштабный проект, ориентированный только на Ваши уникальные навыки.',
    scoutParagraph2:
    ...
    noExperienceTitle: 'Вам не обязательно быть опытным экспертом с большим стартовым капиталом.',
    ...
    noExperienceImportant:
      'В результате Вы получаете детальную архитектуру проекта и пошаговый план запуска проекта с авторскими цифровыми продуктами, продуманной маркетинговой стратегией и рассчитанной воронкой продаж. И вам не нужна команда профессионалов, которая обошлась бы в кругленькую сумму и несколько месяцев ожидания.',
  ...
  en: {
    ...
    welcomeDescription:
      'A Personal Brand is not just a catchy name, beautiful appearance, or a set of posts on social networks. With the help of the "APB" service, you can transform your talents, skills, and your name into a full-fledged digital asset with high monetization potential.\nOn one single condition — if you yourself decide to treat it as seriously as any project aimed at sustainable financial results. The "cherry on top" lies in the fact that the online business called "Personal Brand" belongs only to YOU.',
    ...
    secretParagraph2:
      '"Architect of Personal Brands" works differently. With the help of the service tools, you are not just "PR-ing" yourself, but designing your online business from scratch.\nYou develop a full-fledged, effective, and income-oriented business model tailored to You as a specific individual: starting from deep audit and positioning development to designing original digital products with a calculated business plan, including a financial model and a roadmap.',

    serviceTitle: 'What exactly do you create with the help of the service?',
    serviceIntro:
      'Imagine that a Personal Brand is your house. Ordinary specialists can beautifully paint the walls, do interior design, hang expensive curtains (do advertising and PR).\nWith the help of the "Architect of Personal Brands" service, you design and build a "building" from scratch: lay the foundation, lay communications, erect load-bearing structures, and only then proceed to finishing and landscaping.',
    serviceCards: [
      {
      ...
      },
      {
        ...
        description:
          'With the help of the service tools, you conduct market and niche research to determine an optimal pricing strategy. You form a detailed business plan and financial model — documents whose creation by professional analysts costs thousands of dollars and takes months.',
        icon: 'financial',
      },
      {
    ...
    reliabilityParagraph2:
      'The AI-service "Architect of Personal Brands" is an author\'s project of a professional business consultant known under the pseudonym Business Pathfinder, with 28 years of experience in crisis management, business analytics, M&A deal support, and expansion into international markets.',
    reliabilityParagraph3:
    ...
    brandParagraph2:
      "With the help of the service, you design a Personal Brand based on your inner world and talents, not on a picture. If you don't want to show your face — you don't have to. With the help of the APB methodology, you create a business model that can work even when you stay in the shadows.",
    brandListItems: [],
    brandParagraph3: '',
    ...
    noExperienceTitle: "You don't necessarily need to be an experienced expert with a large starting capital.",
    noExperienceParagraph1:
    ...
    noExperienceImportantLabel: '',
    noExperienceImportant:
      "As a result, you receive a detailed project architecture and a step-by-step launch plan with original digital products, a well-thought-out marketing strategy, and a calculated sales funnel. And you don't need a team of professionals that would cost a pretty penny and several months of waiting.",
