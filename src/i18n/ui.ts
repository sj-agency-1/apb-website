...
export const ui = {
  ru: {
    ...
    // Hero
    'hero.tagline': 'AI-сервис Архитектор Личных Брендов',
    'hero.title': 'Создайте свой самый надёжный онлайн-бизнес',
    'hero.cta': 'За 10 шагов',

    // Section: About (content chapters)
    'about.sectionTitle': 'АРХИТЕКТОР ЛИЧНЫХ БРЕНДОВ',
    'chapter1.label': 'Глава 1',
    'chapter1.title': 'Добро пожаловать на официальный сайт AI-сервиса «Архитектор Личных Брендов».',
    'chapter1.content':
    ...
    'chapter2.label': 'Глава 2',
    'chapter2.title': 'Главный секрет: Зарабатывайте на своих навыках и скрытых возможностях, а не на публичности',
    'chapter2.content':
    ...
    'chapter3.label': 'Глава 3',
    'chapter3.title': 'От потенциала к прибыльному бизнес-плану',
    'chapter3.content':
    ...
    'chapter4.label': 'Глава 4',
    'chapter4.title': 'Ваше преимущество: скорость и доступная цена',
    'chapter4.content':
    ...
    'chapter5.label': 'Глава 5',
    'chapter5.title': 'Почему стоит создать онлайн бизнес с AI-сервисом «Архитектор Личных Брендов»',
    'chapter5.content':
    ...
    // CTA Card
    'cta.create.title': 'СОЗДАТЬ свой онлайн бизнес',
    'cta.create.subtitle': 'Который называется Личный Бренд',
    'cta.create.button': 'Создать',

    // Advantages Section
    'advantages.title': 'Достоинства',
    'advantages.subtitle': 'AI-сервиса «Архитектор Личных Брендов»',

    'advantage1.title': 'Поиск Ваших «Бриллиантов»',
    'advantage1.description':
    ...
    'advantage2.title': 'Бизнес-Модель',
    'advantage2.description':
    ...
    'advantage3.title': 'Создание Цифровых Продуктов',
    'advantage3.description':
    ...
    'advantages.cta.title': 'Узнайте',
    'advantages.cta.subtitle': 'Обо всех достоинствах сервиса «Архитектор Личных Брендов»',
    'advantages.cta.button': 'Подробнее',

    // Steps Section
    'steps.title': '10 ШАГОВ',
    'steps.subtitle': 'К созданию своего онлайн бизнеса',

    'step1.title': 'АУДИТ',
    'step1.description': 'AI поможет найти Ваш скрытый потенциал – ваши «бриллианты»',

    'step2.title': 'Позиционирование',
    'step2.description': 'Узнайте, как и с чем выйти в мир и кто Ваша ЦА',

    'step3.title': 'Монетизация',
    'step3.description': 'Определите модели монетизации, которые наиболее точно подходят именно для Вас',

    'step4.title': 'Создание продукта',
    'step4.description': 'Создайте свой первый цифровой продукт, который будет приносить вам доход',

    'step5.title': 'Исследование и маркетинговая стратегия',
    'step5.description':
    ...
    'steps.cta.title': 'Узнать всё',
    'steps.cta.subtitle': 'Как работает AI-сервиса «Архитектор Личных Брендов»',
    'steps.cta.button': 'Подробнее',

    // FAQ Section
    'faq.title': 'Часто задаваемые вопросы',
    'faq.subtitle': 'О AI-сервисе «Архитектор Личных Брендов»',
    ...
    'faq2.question': 'А сколько это стоит?',
    'faq2.answer':
    ...
    'faq3.question':
      'А кто будет изучать мои ответы на вопросы анкеты? Информация обо мне никуда не уйдет? Это безопасно?',
    'faq3.answer':
    ...
    'faq4.question': 'Сколько времени дается на прохождение каждого этапа?',
    'faq4.answer':
    ...
    'reviews.subtitle': 'О AI-сервисе «Архитектор Личных Брендов»',
    'reviews.cta.title': 'Читать все',
    'reviews.cta.subtitle': 'Отзывы об AI-сервисе «Архитектор Личных Брендов»',
    'reviews.cta.button': 'Подробнее',
  ...
  en: {
    ...
    // Hero
    'hero.tagline': 'AI-service Architect of Personal Brands',
    'hero.title': 'Create your most reliable online business',
    'hero.cta': 'In 10 steps',

    // Section: About (content chapters)
    'about.sectionTitle': 'ARCHITECT OF PERSONAL BRANDS',
    'chapter1.label': 'Chapter 1',
    'chapter1.title': 'Welcome to the official website of the AI-service "Architect of Personal Brands".',
    'chapter1.content':
    ...
    'chapter2.title': 'The main secret: Earn on your skills and hidden opportunities, not on publicity',
    'chapter2.content':
    ...
    'chapter3.title': 'From potential to a profitable business plan',
    'chapter3.content':
    ...
    'chapter4.label': 'Chapter 4',
    'chapter4.title': 'Your advantage: speed and affordable price',
    'chapter4.content':
    ...
    'chapter5.label': 'Chapter 5',
    'chapter5.title': 'Why you should create an online business with the AI-service "Architect of Personal Brands"',
    'chapter5.content':
    ...
    // CTA Card
    'cta.create.title': 'CREATE your online business',
    'cta.create.subtitle': 'Called Personal Brand',
    'cta.create.button': 'Create',

    // Advantages Section
    'advantages.title': 'Advantages',
    'advantages.subtitle': 'Of the AI-service "Architect of Personal Brands"',

    'advantage1.title': 'Finding Your "Diamonds"',
    'advantage1.description':
    ...
    'advantage2.title': 'Business Model',
    'advantage2.description':
    ...
    'advantage3.title': 'Creating Digital Products',
    'advantage3.description':
    ...
    'advantage4.title': 'Accessibility & Speed',
    'advantage4.description':
    ...
    'advantages.cta.title': 'Learn more',
    'advantages.cta.subtitle': 'About all the advantages of the "Architect of Personal Brands" service',
    'advantages.cta.button': 'More details',

    // Steps Section
    'steps.title': '10 STEPS',
    'steps.subtitle': 'To creating your online business',

    'step1.title': 'AUDIT',
    'step1.description': 'AI will help find your hidden potential – your "diamonds"',

    'step2.title': 'Positioning',
    'step2.description': 'Find out how and with what to enter the world and who your target audience is',

    'step3.title': 'Monetization',
    'step3.description': 'Determine the monetization models that are most suitable for you',

    'step4.title': 'Product Creation',
    'step4.description': 'Create your first digital product that will bring you income',

    'step5.title': 'Research and Marketing Strategy',
    'step5.description':
    ...
    'step10.title': 'Content Production',
    'step10.description':
    ...
    'steps.cta.title': 'Learn everything',
    'steps.cta.subtitle': 'How the AI-service "Architect of Personal Brands" works',
    'steps.cta.button': 'More details',

    // FAQ Section
    'faq.title': 'Frequently Asked Questions',
    'faq.subtitle': 'About the AI-service "Architect of Personal Brands"',
    ...
    'faq2.question': 'How much does it cost?',
    'faq2.answer':
    ...
    'faq3.question':
      'Who will study my answers to the questionnaire? Will information about me go anywhere? Is it safe?',
    'faq3.answer':
    ...
    'faq4.question': 'How much time is given to complete each stage?',
    'faq4.answer':
    ...
    'reviews.subtitle': 'About the AI-service "Architect of Personal Brands"',
    'reviews.cta.title': 'Read all',
    'reviews.cta.subtitle': 'Reviews about the AI-service "Architect of Personal Brands"',
    'reviews.cta.button': 'More details',
